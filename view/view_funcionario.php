...
<div class="container">
	...
	<form action="../controller/incluir_funcionario.php" method="post">
		<fieldset>
            ...
            <label>Nome Completo</label><div class="form-group">
  			...
  			<table class="table table-hover">
  				...
  				?>	
    				<tr>
    					...
    					<td class="col-md-2"><?php echo $objetoFuncionario->getNome(); ?></td>
    					<td class="col-md-2"><?php echo $objetoFuncionario->getCpf(); ?></td>
    					<td class="col-md-2"><?php echo date('d/m/Y',  strtotime($objetoFuncionario->getDataAdmissao())); ?></td>
    					<td class="col-md-1"><?php echo $objetoFuncionario->getStatus();?></td>
    					<td class="col-md-2"><?php echo $objetoFuncionario->getCargo()->getNome();?></td>
    					<td class="col-md-1">
