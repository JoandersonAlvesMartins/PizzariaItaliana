  			...
  			<table class="table table-hover">
  				...
  				?>	
    				<tr>
    					...
    					<td class="col-md-2"><?php echo date('d/m/Y',  strtotime($objetoComanda->getDataCompra())); ?></td>
    					<td class="col-md-2"><?php echo $objetoComanda->getFormaPagamento(); ?></td>			
    					<td class="col-md-1"><?php echo $objetoComanda->getStatus();?></td>
    					<td class="col-md-2"><?php echo $objetoComanda->getFuncionario()->getNome();?></td>
    					<td class="col-md-2"><?php echo $objetoComanda->getPizza()->getNome();?></td>
    					<td class="col-md-1">
